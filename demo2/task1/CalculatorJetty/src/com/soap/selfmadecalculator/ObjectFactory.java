 ...
 * generated in the com.soap.selfmadecalculator package. 
...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("hhtp://CalcWS", "add");
    private final static QName _AddResponse_QNAME = new QName("hhtp://CalcWS", "addResponse");
    private final static QName _Divide_QNAME = new QName("hhtp://CalcWS", "divide");
    private final static QName _DivideResponse_QNAME = new QName("hhtp://CalcWS", "divideResponse");
    private final static QName _Multiply_QNAME = new QName("hhtp://CalcWS", "multiply");
    private final static QName _MultiplyResponse_QNAME = new QName("hhtp://CalcWS", "multiplyResponse");
    private final static QName _Subtract_QNAME = new QName("hhtp://CalcWS", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("hhtp://CalcWS", "subtractResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.soap.selfmadecalculator
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "hhtp://CalcWS", name = "add")
     ...
     */
    @XmlElementDecl(namespace = "hhtp://CalcWS", name = "addResponse")
     ...
     */
    @XmlElementDecl(namespace = "hhtp://CalcWS", name = "divide")
     ...
     */
    @XmlElementDecl(namespace = "hhtp://CalcWS", name = "divideResponse")
     ...
     */
    @XmlElementDecl(namespace = "hhtp://CalcWS", name = "multiply")
     ...
     */
    @XmlElementDecl(namespace = "hhtp://CalcWS", name = "multiplyResponse")
     ...
     */
    @XmlElementDecl(namespace = "hhtp://CalcWS", name = "subtract")
     ...
     */
    @XmlElementDecl(namespace = "hhtp://CalcWS", name = "subtractResponse")
